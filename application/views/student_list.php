 ...
 <div class="row ">
        <div class="col-lg-2">
          <h3>Student List Codeigniter</h3>   
        </div>
...
<table class="table">
            ...
            <tbody>
                ...
                <td class="text-right">
                    ...
                    <a onclick="return confirm('Estás seguro que deseas eliminar el registro?');" href="<?php echo site_url('delete-student-info').'/'.$value['student_id'];?>"    class="button button-red" >Delete</a> 
